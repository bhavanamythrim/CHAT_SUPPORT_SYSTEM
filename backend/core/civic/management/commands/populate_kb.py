...
EXTRA_ENTRIES = [
    ...
    # WATER BILL (multi-language)
    { 'question': 'How can I pay my water bill online?', 'answer': 'Pay through your city water board/municipal portal. Steps: 1) Open the official water board website/app. 2) Enter your consumer/connection number. 3) View the bill and pay via UPI/card/net banking. You can also pay at nearby service centers.', 'language': 'en', 'category': 'Water Supply' },
    { 'question': 'My water bill is very high. How do I raise a complaint?', 'answer': 'Register a billing complaint with your municipal water board. Keep your consumer number and last bill. Use the portal’s “billing dispute” option or call the water board helpline. If an error is found, a revised bill will be issued.', 'language': 'en', 'category': 'Water Supply' },

    { 'question': 'पानी का बिल ऑनलाइन कैसे भरें?', 'answer': 'अपने नगर निगम/जल बोर्ड की वेबसाइट या ऐप पर जाएं। चरण: 1) उपभोक्ता/कनेक्शन नंबर दर्ज करें। 2) बिल देखें। 3) UPI/कार्ड/नेट बैंकिंग से भुगतान करें। नज़दीकी सेवा केंद्र पर भी भुगतान किया जा सकता है।', 'language': 'hi', 'category': 'Water Supply' },
    { 'question': 'पानी का बिल बहुत ज्यादा है, शिकायत कैसे करें?', 'answer': 'जल बोर्ड/नगर निगम में बिलिंग शिकायत दर्ज करें। उपभोक्ता नंबर और पिछला बिल साथ रखें। पोर्टल पर “बिलिंग विवाद” विकल्प चुनें या हेल्पलाइन पर कॉल करें। जांच के बाद सही बिल जारी किया जा सकता है।', 'language': 'hi', 'category': 'Water Supply' },

    { 'question': 'தண்ணீர் கட்டணத்தை ஆன்லைனில் எப்படி செலுத்தலாம்?', 'answer': 'நகராட்சி/குடிநீர் வாரியம் இணையதளம் அல்லது ஆப்பில் செலுத்தலாம். படிகள்: 1) நுகர்வோர்/கணக்கு எண்ணை உள்ளிடவும். 2) கட்டணத்தை பார்க்கவும். 3) UPI/கார்டு/நெட் பேங்கிங் மூலம் செலுத்தவும். அருகிலுள்ள சேவை மையத்திலும் செலுத்தலாம்.', 'language': 'ta', 'category': 'Water Supply' },
    { 'question': 'தண்ணீர் கட்டணம் அதிகமாக வந்தது. புகார் எப்படி செய்வது?', 'answer': 'குடிநீர் வாரியம்/நகராட்சியில் பிலிங் புகார் பதிவு செய்யவும். நுகர்வோர் எண் மற்றும் கடந்த பிலை வைத்திருங்கள். “Billing dispute” மூலம் அல்லது ஹெல்ப்லைனில் புகார் செய்யலாம். சரிபார்ப்புக்குப் பிறகு திருத்திய பில் வழங்கப்படும்.', 'language': 'ta', 'category': 'Water Supply' },

    { 'question': 'నీటి బిల్లును ఆన్‌లైన్‌లో ఎలా చెల్లించాలి?', 'answer': 'మీ నగర నీటి బోర్డు/మునిసిపాలిటీ పోర్టల్‌లో చెల్లించండి. దశలు: 1) వినియోగదారు/కనెక్షన్ నంబర్ నమోదు చేయండి. 2) బిల్లు చూడండి. 3) UPI/కార్డు/నెట్ బ్యాంకింగ్ ద్వారా చెల్లించండి. సమీప సేవా కేంద్రంలో కూడా చెల్లించవచ్చు.', 'language': 'te', 'category': 'Water Supply' },
    { 'question': 'నీటి బిల్లు ఎక్కువ వచ్చింది. ఫిర్యాదు ఎలా చేయాలి?', 'answer': 'నీటి బోర్డు/మునిసిపాలిటీ వద్ద బిలింగ్ ఫిర్యాదు నమోదు చేయండి. వినియోగదారు నంబర్ మరియు గత బిల్లును కలిగి ఉండండి. పోర్టల్‌లో “బిల్లింగ్ వివాదం” ఎంపిక లేదా హెల్ప్‌లైన్‌కు కాల్ చేయండి. తనిఖీ తరువాత సవరించిన బిల్లు ఇస్తారు.', 'language': 'te', 'category': 'Water Supply' },

    { 'question': 'വാട്ടർ ബിൽ ഓൺലൈനായി എങ്ങനെ അടയ്ക്കാം?', 'answer': 'നഗര വാട്ടർ ബോർഡ്/മുനിസിപ്പാലിറ്റി പോർട്ടൽ അല്ലെങ്കിൽ ആപ്പിൽ അടയ്ക്കാം. ഘട്ടങ്ങൾ: 1) ഉപഭോക്തൃ/കണക്ഷൻ നമ്പർ നൽകുക. 2) ബിൽ കാണുക. 3) UPI/കാർഡ്/നെറ്റ് ബാങ്കിംഗ് വഴി അടയ്ക്കുക. സമീപ സേവന കേന്ദ്രങ്ങളിലും അടയ്ക്കാം.', 'language': 'ml', 'category': 'Water Supply' },
    { 'question': 'വാട്ടർ ബിൽ കൂടുതലാണ്. പരാതി എങ്ങനെ നൽകാം?', 'answer': 'വാട്ടർ ബോർഡ്/മുനിസിപ്പാലിറ്റിയിൽ ബില്ലിംഗ് പരാതി രജിസ്റ്റർ ചെയ്യുക. ഉപഭോക്തൃ നമ്പറും കഴിഞ്ഞ ബിലും കൈയിൽവെക്കുക. പോർട്ടലിൽ “Billing dispute” തിരഞ്ഞെടുക്കുക അല്ലെങ്കിൽ ഹെൽപ്‌ലൈനിലേക്ക് വിളിക്കുക. പരിശോധനയ്ക്ക് ശേഷം തിരുത്തിയ ബിൽ നൽകാം.', 'language': 'ml', 'category': 'Water Supply' },

    { 'question': 'ನೀರಿನ ಬಿಲ್ ಆನ್‌ಲೈನ್‌ನಲ್ಲಿ ಹೇಗೆ ಪಾವತಿಸಬೇಕು?', 'answer': 'ನಿಮ್ಮ ನಗರ ವಾಟರ್ ಬೋರ್ಡ್/ಮುನಿಸಿಪಾಲಿಟಿ ಪೋರ್ಟಲ್‌ನಲ್ಲಿ ಪಾವತಿಸಿ. ಹಂತಗಳು: 1) ಗ್ರಾಹಕ/ಕನೆಕ್ಷನ್ ಸಂಖ್ಯೆ ನಮೂದಿಸಿ. 2) ಬಿಲ್ ನೋಡಿ. 3) UPI/ಕಾರ್ಡ್/ನೆಟ್ ಬ್ಯಾಂಕಿಂಗ್ ಮೂಲಕ ಪಾವತಿಸಿ. ಹತ್ತಿರದ ಸೇವಾ ಕೇಂದ್ರದಲ್ಲೂ ಪಾವತಿಸಬಹುದು.', 'language': 'kn', 'category': 'Water Supply' },
    { 'question': 'ನೀರಿನ ಬಿಲ್ ಹೆಚ್ಚು ಬಂದಿದೆ. ದೂರು ಹೇಗೆ ಮಾಡಬೇಕು?', 'answer': 'ವಾಟರ್ ಬೋರ್ಡ್/ಮುನಿಸಿಪಾಲಿಟಿಯಲ್ಲಿ ಬಿಲ್ಲಿಂಗ್ ದೂರು ದಾಖಲಿಸಿ. ಗ್ರಾಹಕ ಸಂಖ್ಯೆ ಮತ್ತು ಹಿಂದಿನ ಬಿಲ್ ಇಟ್ಟುಕೊಳ್ಳಿ. ಪೋರ್ಟಲ್‌ನಲ್ಲಿ “Billing dispute” ಆಯ್ಕೆ ಮಾಡಿ ಅಥವಾ ಹೆಲ್ಪ್‌ಲೈನ್‌ಗೆ ಕರೆ ಮಾಡಿ. ಪರಿಶೀಲನೆಯ ಬಳಿಕ ತಿದ್ದುಪಡಿ ಬಿಲ್ ನೀಡಬಹುದು.', 'language': 'kn', 'category': 'Water Supply' },

    { 'question': 'पाणी बिल ऑनलाइन कसे भरायचे?', 'answer': 'नगरपालिका/जल मंडळाच्या पोर्टलवर बिल भरा. टप्पे: 1) ग्राहक/कनेक्शन नंबर टाका. 2) बिल पाहा. 3) UPI/कार्ड/नेट बँकिंगने पेमेंट करा. जवळच्या सेवा केंद्रातही भरता येते.', 'language': 'mr', 'category': 'Water Supply' },
    { 'question': 'पाणी बिल जास्त आले आहे. तक्रार कशी करायची?', 'answer': 'जल मंडळ/नगरपालिकेत बिल्लिंग तक्रार नोंदवा. ग्राहक क्रमांक आणि मागील बिल ठेवा. पोर्टलवरील “Billing dispute” पर्याय वापरा किंवा हेल्पलाइनवर कॉल करा. तपासणीनंतर सुधारित बिल दिले जाऊ शकते.', 'language': 'mr', 'category': 'Water Supply' },

    { 'question': 'জল বিল অনলাইনে কীভাবে পরিশোধ করবো?', 'answer': 'আপনার শহরের জল বোর্ড/পৌরসভার পোর্টালে বিল দিন। ধাপ: 1) কনজিউমার/কনেকশন নম্বর দিন। 2) বিল দেখুন। 3) UPI/কার্ড/নেট ব্যাংকিং দিয়ে পেমেন্ট করুন। কাছের সার্ভিস সেন্টারেও পরিশোধ করা যায়।', 'language': 'bn', 'category': 'Water Supply' },
    { 'question': 'জল বিল বেশি এসেছে। অভিযোগ কীভাবে করবো?', 'answer': 'জল বোর্ড/পৌরসভায় বিলিং অভিযোগ জানান। কনজিউমার নম্বর ও আগের বিল রাখুন। পোর্টালের “Billing dispute” অপশন ব্যবহার করুন বা হেল্পলাইনে কল করুন। যাচাইয়ের পরে সংশোধিত বিল দেওয়া হতে পারে।', 'language': 'bn', 'category': 'Water Supply' },
]
